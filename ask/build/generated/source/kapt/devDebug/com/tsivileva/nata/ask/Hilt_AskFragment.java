...
public abstract class Hilt_AskFragment extends Fragment implements GeneratedComponentManager<Object> {
    ...
    Hilt_AskFragment(int contentLayoutId) {
    ...
    protected void inject() {
        ((AskFragment_GeneratedInjector) generatedComponent()).injectAskFragment(UnsafeCasts.<AskFragment>unsafeCast(this));
    }
